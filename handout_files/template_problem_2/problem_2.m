...
% [a_eq_gen, b_eq_gen] = gen_aeq(A1, B1, N, mx,mu);
Aeq = gen_aeq(A1, B1, N, mx,mu);     % Generate A, hint: gen_aeq gen_aeq = |A|B|
beq = zeros(size(Aeq, 1),1);             % Generate b


%% Solve QP problem with linear model
tic
[z,lambda] = quadprog(Q, c, [], [], Aeq, beq, ul,uu,x0); % hint: quadprog. Type 'doc quadprog' for more info 
t1=toc;
