...
void helicopter_output(void)
{
   ...
   *  Sum: '<S5>/Sum3'
   */
  rtb_Clock = ((helicopter_P.pitch_ref_Value - helicopter_P.Gain1_Gain *
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (2523209037U);
  helicopter_M->Sizes.checksums[1] = (3290962485U);
  helicopter_M->Sizes.checksums[2] = (1580170474U);
  helicopter_M->Sizes.checksums[3] = (2935016958U);
